...
def main() -> int:
    ...
    specs = [
        ...
        ("voi_history_14d_manifest.json", "Complete 14-day VOI history — shard manifest", "voi_history", "Index of the complete retained 14-day VOI history. Each listed JSONL shard stays below the static-hosting safety limit."),
    ...
    manifest = {
        ...
        "groups": [
            ...
            {"id": "voi_history", "label": "VOI history"},
    ...
    data_manifest = {
        ...
        "voi_history_compatibility": "./data/vessels/voi_history_14d.jsonl",
        "voi_history_full_manifest": "./data/vessels/voi_history_14d/manifest.json",
